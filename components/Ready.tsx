		...
		<section
			...
			<div className="w-full h-full flex justify-center gap-[50px] items-center flex-col">
				...
				<div className="flex flex-col items-center gap-[10px]">
					...
					<div className="flex items-center justify-between bg-transparent cursor-pointer rounded-full group border border-[#1B2B6B]">
						<Link
							...
							<Rounded
								...
								<p className="z-10 px-[10px] ml-[15px] py-[6px] group-hover:text-white text-secondry">
									Explore Our Services
								</p>
								<div className="bg-secondry group-hover:bg-white text-white p-[10px] rounded-full scale-[0.3] mr-[10px] group-hover:scale-[0.9] transition-all z-10 transform duration-[0.3s] ease-[.215,.61,.355,1]">
									<ArrowUpRight
										strokeWidth={1.5}
										size={30}
